...
const COMMON_FORM_FIELDS: Record<string, Array<{ fieldKey: string; label: string; fieldType: string; isRequired: boolean; displayOrder: number; placeholder?: string; options?: string }>> = {
  mentor: [
